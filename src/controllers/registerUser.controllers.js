...
const generateAccessRefreshToken = async (userId) =>{
  try {
    ...
    throw new ApiError(401,"Something went wrong while creating refresh and access token" );
  }
}
...
const registerUser = asyncHandler(async (req, res) => {
 ...
 const loginUser = asyncHandler(async (req,res)=>{
     ...
     json(new ApiResponse(200,{user:loggedInUser,accessToken:accessToken,refreshToken:refreshToken},"User login Successfully"))
 ...
 const generateRefreshToken = asyncHandler((req,res)=>{
     ...
     const decodeRefreshToken = jwt.verify(incomingRefreshToken,process.env.RERESH_TOKEN_SECRET);
     ...
     const {accessToken,refreshToken:newRefreshToken} = generateAccessRefreshToken(user_id);
